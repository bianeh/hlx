		...
		<div class="order-nav">
				<div class="nav">
					<div id="segmentedControl" class="mui-segmented-control">
						...
						<a class="mui-control-item mui-active haspayment" href="/order/haspayment">待发货</a>
				...
				<div class="cart-list-group mui-control-content mui-active" id="item1">
					<div class="list orderId" type="1 ">
						...
						<ul class="mui-table-view up-table-wiew">
                          ...
                          <?php } ?>
							<li class="order-table-view-cell"><h2 class="order-title"><em>(包含礼盒价)</em> 合计：<i class="price-icon">￥</i><span class="price"><?= $value['total_price'] ?>.00</span></h2>
							</li>
							<li class="order-table-view-cell clearfix" orderno="2017121352481005">
								<!-- <a class="service-btn method-btn methodId" style="margin-left: 0.2rem" remindstatus="0">提醒发货</a> -->
