...
<html>
	...
	<head>
        ...
        <?php $strstate=['未支付','已支付','已发货','已收货','超时未支付']; ?>
	<body>
		<!--header start-->
		...
		<div class="order-nav">
				<div class="nav">
					<div id="segmentedControl" class="mui-segmented-control">
                                                <a class="mui-control-item allorder" href="/order/index">全部</a>
						<a class="mui-control-item payment" href="/order/paymenting">待付款</a>
						<a class="mui-control-item haspayment" href="/order/haspayment">待发货</a>
						<a class="mui-control-item mui-active express" href="/order/express">待收货</a>
						<a class="mui-control-item getgoods" href="/order/getgoods">待评价</a>
					</div>
				</div>
		</div>
		<!--header end-->
				...
				<div class="cart-list-group mui-control-content mui-active" id="item1">
					<div class="list orderId" type="1 ">
						...
						<ul class="mui-table-view up-table-wiew">
                          ...
                          <?php } ?>
							<li class="order-table-view-cell"><h2 class="order-title"><em>(包含礼盒价)</em> 合计：<i class="price-icon">￥</i><span class="price"><?= $value['total_price'] ?>.00</span></h2></li><li class="order-table-view-cell clearfix" orderno="2017121352481005"><a class="service-btn method-btn methodId" style="margin-left: 0.2rem" remindstatus="0">提醒发货</a><a class="service-btn customerId" href="tel:0278766188" mce_href="tel:0278766188">客服热线</a></li></ul></div>
				</div>
                                <?php } ?>
			</div>
		</div>
	...
	<!--<script src="<?php echo Yii::$app->params['common_url'];?>/js/order.js"></script>-->
