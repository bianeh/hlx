		...
		<div class="order-nav">
				<div class="nav">
					<div id="segmentedControl" class="mui-segmented-control">
						...
						<a class="mui-control-item mui-active payment" href="/order/paymenting">待付款</a>
						...
						<ul class="mui-table-view up-table-wiew">
                          ...
                          <?php } ?>
							<li class="order-table-view-cell">
								<h2 class="order-title"><em>(包含礼盒价)</em> 合计：<i class="price-icon">￥</i><span class="price"><?= $value['price'] ?>.00</span>
								</h2>
							</li>
							<li class="order-table-view-cell clearfix" orderno="2017121352481005">
								<a  class="service-btn method-btn methodId gopayment" style="margin-left: 0.2rem" remindstatus="0">前去付款</a>
