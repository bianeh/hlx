...
<!--header end-->
<!--保存并使用开始-->
<!-- <a class="add" id="editAddress">
     编辑并使用
</a> -->
<!--保存并使用结束-->
<!--内容开始-->
<div class="content">
    <form id="editaddressform" action="/address/doeditaddress" method="post" />
            <div class="user">
                <span>收件人：</span>
                <input type="text"  value="<?= $addressinfo['linker'] ?>" placeholder="请填写用户名" id="linker" name="linker">
            </div>
            <div class="user">
                <span>联系方式：</span>
                <input type="tel" value="<?= $addressinfo['phone'] ?>" placeholder="请填写手机号" id="phone" name="phone">
            </div>
            <div class="user">
            ...
            <div class="user">
                <input type="text" value="<?= $addressinfo['detail'] ?>" name="detail" placeholder="详细地址" style="margin-left: 0.66rem" id="userAdress">
            </div>
            <div>
                <div class="mui-input-row mui-checkbox ">
                    <label style="margin-top:4px;margin-left: 0.35rem">是否设置为常用地址</label>
                    <?php $isdefault = $addressinfo['isdefault'];if($isdefault == 1) { ?>
                     <input name="Checkbox" type="checkbox"  checked style="top:50%; margin-top:-13px;" id="isDefault">
                    <?php } ?>
                     <?php $isdefault = $addressinfo['isdefault'];if($isdefault == 0) { ?>
