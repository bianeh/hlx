...
<div class="site-login">
    <h1></h1>
    <form action="/bigpic/add" id="addbigpic" method="post" enctype="multipart/form-data">
        ...
        <br>
            <div class="form-group col-md-12">
                <div class="col-md-offset-1 col-md-11">
                    <a id="addbigpicopertator" class="btn btn-primary">添加商品大图</a>
                </div>
            </div>
...
<script>
    addbigpicopertator = document.getElementById("addbigpicopertator");
    addbigpicopertator.onclick = function(){
        document.getElementById("addbigpic").submit();
    }
</script>
