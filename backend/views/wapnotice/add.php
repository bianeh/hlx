...
<body>
<div class="title"><a href="/wapnotice/index">前端设置</a>->添加公告</div>
<div class="base">
<div class="site-login">
    <h1></h1>
    <form action="" id="addnotice" method="post" enctype="multipart/form-data">
        ...
        <div class="form-group col-md-12">
            ...
            <div class="form-group col-md-12">
                <div class="col-md-offset-1 col-md-11">
                    <a id="addnoticeopertator" class="btn btn-primary">添加</a>
                </div>
            </div>
